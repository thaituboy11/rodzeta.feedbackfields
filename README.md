...
- данный модуль будет полезен для редакций не включающих модуль Веб-формы (Первый сайт и Старт) и имеет более простые настройки и упрощает интеграцию дизайна;
